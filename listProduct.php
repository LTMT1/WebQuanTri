  ...
  <div class="content-wrapper" style="min-height: 3072.19px;">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <input style="width: 200px;" name="searchx" value="<?php if(isset($_GET["searchx"])) {echo $_GET["searchx"];} ?>" class="form-control me-2" type="text" placeholder="Search Sản Phẩm">
          ...
          <tbody>
            <?php 
             ...
             <td style="width: 100px;"><?php echo $idStt++ ?></td>
              ...
              <td  style="width: 30px;"><a href="updateProduct.php?id_product=<?php echo $row['id_product']; ?>" >Sửa</a></td>
              <td style="width: 30px;"><a href="deleteProduct.php?id=<?php echo $row['id_product']; ?>" onclick="return confirm('Sản Phẩm sẽ bị xóa khỏi danh sách?')">Xóa</a></td>
              ...
              <a class="btn btn-primary" href="addProduct.php">Thêm sản phẩm mới </a>
              <!-- /.card -->
            </div>
