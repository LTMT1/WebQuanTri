<?php 
    ...
    $errors ="";
    $id = $_GET['id_staff'];
    $sql_up = "SELECT * FROM Staff WHERE id_staff = '$id'";
    ...
    $linkimage = $row_up['image'];
        ...
        $statusMsg = "";
        $id_update = test_input($_POST['id_staff']);
            ...
            <!-- form start -->
              ...
              <div class="card-body">
                <div class="form-group">
                    <div>
                         <input type="hidden"  name="id_staff" value="<?php echo $row_up['id_staff'] ?>">
                    </div>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Tên Nhân Viên</label>
                  <input type="text" class="form-control" name="user_name" value="<?php echo $row_up['user_name']; ?>" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="birthday" value="<?php echo $row_up['birthday']; ?>" >
                   <span class="focus-input100" style="color:red"><?php echo $error; ?></span>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">SĐT</label>
                  <input type="text" class="form-control" name="phone_number" value="<?php echo $row_up['phone_number']; ?>">
                   <span class="focus-input100" style="color:red"><?php echo $error; ?></span>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Địa Chỉ</label>
                  <input type="text" class="form-control" name="address" value="<?php echo $row_up['address']; ?>">
                   <span class="focus-input100" style="color:red"><?php echo $error; ?></span>
                </div>
              </div>
              <!-- /.card-body -->
