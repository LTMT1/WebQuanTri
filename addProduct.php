...
//   error_reporting(0);
  ...
  $query_product_type = mysqli_query($conn,$sql_product_type);
        ...
        $id_product_type = test_input($_POST['id_product_type']);
           ...
           if($product_name == "" && $processing_time =="" && $price == "" && $description == "" && $fileName == "" ){
                $error = "Vui lòng nhập dữ liệu ";
                 ...
                 $sql = "insert into Product (id_product_type,product_name,image,processing_time,price,description) values ('$id_product_type','$product_name','$linkimage','$processing_time','$price','$description')";
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" action="" enctype="multipart/form-data" >
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="processing_time" placeholder="">
                   <span class="focus-input100" style="color:red"><?php echo $error; ?></span>
                </div>
                <div class="form-group">
